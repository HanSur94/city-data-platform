...
- [x] 08-03-PLAN.md — Frontend: community/infrastructure layers, popups, sidebar, MapView, page.tsx
...
- [x] 06-04-PLAN.md — Frontend: WaterLayer + WmsOverlayLayer + Sidebar toggles + MapView + page.tsx wiring (WATR-01/03/04/05)
